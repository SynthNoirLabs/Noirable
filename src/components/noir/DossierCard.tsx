...
export function DossierCard({ title, description, status = 'active', className }: DossierCardProps) {
  return (
    <div className={cn("bg-paper shadow-lg p-6 relative border border-noir-gray/20 rotate-[-1deg] max-w-md", className)}>
      {/* Stamp */}
      <div className={cn(
