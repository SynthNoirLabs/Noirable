...
export const Button: React.FC<ComponentRendererProps<ButtonType>> = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-sm font-typewriter text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] disabled:opacity-50 disabled:cursor-not-allowed";
