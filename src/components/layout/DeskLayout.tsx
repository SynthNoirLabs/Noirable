            ...
            <div className="mb-4 border-b border-[var(--aesthetic-border)]/20 pb-2 flex items-center justify-between gap-2">
              ...
              {onToggleEditor && (
                <button
                  ...
                  title="Hide editor"
                  className="text-[var(--aesthetic-text-muted)] hover:text-[var(--aesthetic-accent)] focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] focus-visible:outline-none transition-colors p-1 rounded-sm"
                >
            ...
            <div className="flex items-center gap-2 overflow-x-auto">
              {onToggleTraining && (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 px-3 py-1.5 text-xs uppercase tracking-widest font-typewriter border rounded-sm focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] focus-visible:outline-none transition-colors shrink-0",
                    showTraining
