              ...
              <div className="max-h-[280px] overflow-y-auto">
                ...
                {BUILT_IN_PROFILES.map((profile) => (
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center justify-between px-3 py-2 text-sm font-mono transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] -outline-offset-2",
            ...
            <div className="p-3 border border-[var(--aesthetic-border)]/30 rounded-sm space-y-3 bg-[var(--aesthetic-surface)]/30">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 px-3 py-2 text-xs font-mono bg-[var(--aesthetic-accent)] text-[var(--aesthetic-background)] rounded-sm hover:bg-[var(--aesthetic-accent)]/90 transition-colors disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] focus-visible:ring-offset-1 focus-visible:ring-offset-[var(--aesthetic-background)]"
                >
                  Create
                </button>
              </div>
