      ...
      <div className="relative">
        <button
          ...
          className={cn(
            ...
            "bg-[var(--aesthetic-surface)]/50 border rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)]",
            isOpen
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div id="profile-dropdown" role="listbox" className="max-h-[280px] overflow-y-auto">
                {/* Built-in profiles */}
                ...
                {BUILT_IN_PROFILES.map((profile) => (
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center justify-between px-3 py-2 text-sm font-mono transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] focus-visible:ring-inset",
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-1 hover:text-[var(--aesthetic-accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] rounded-sm"
                          ...
                          <button
                            ...
                            className="p-1 hover:text-[var(--aesthetic-error)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] rounded-sm"
            ...
            <div className="p-3 border border-[var(--aesthetic-border)]/30 rounded-sm space-y-3 bg-[var(--aesthetic-surface)]/30">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 px-3 py-2 text-xs font-mono bg-[var(--aesthetic-accent)] text-[var(--aesthetic-background)] rounded-sm hover:bg-[var(--aesthetic-accent)]/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--aesthetic-surface)]"
                >
                  Create
                </button>
              </div>
