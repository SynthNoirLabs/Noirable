      ...
      <div className="space-y-1.5 relative">
        ...
        <div className="relative">
          <button
            ...
            aria-controls={activeDropdown === "provider" ? "provider-listbox" : undefined}
            aria-labelledby="provider-label provider-trigger"
                  ...
                  {PROVIDERS.map((provider) => (
                    ...
                    >
                      ...
                      {modelConfig.provider === provider.id && (
                        <Check
                          aria-hidden="true"
                          className="w-3 h-3 text-[var(--aesthetic-accent)]"
                        />
                      )}
                    </button>
                  ))}
        ...
        {isAutoProvider ? (
          ...
          <div className="relative">
            <button
              ...
              aria-controls={activeDropdown === "model" ? "model-listbox" : undefined}
