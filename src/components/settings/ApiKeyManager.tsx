      ...
      <div className="relative flex gap-2">
        <div className="relative flex-1">
          ...
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-[var(--aesthetic-text-muted)] hover:text-[var(--aesthetic-text)] transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aesthetic-accent)]"
    ...
    <div className="space-y-6">
      ...
      {(apiKeys.elevenlabs || apiKeys.openai) && (
        <button
          ...
          title="Remove all stored API keys permanently"
