    ...
    <div className="h-full flex flex-col bg-[var(--aesthetic-background)]/95 text-[var(--aesthetic-text)]">
      ...
      <div className="p-4 border-b border-[var(--aesthetic-border)]/30 flex gap-3">
        <button
          ...
          title={trainingExamples.length === 0 ? "No data to export" : "Export data to JSONL"}
        ...
        <button
          ...
          disabled={trainingExamples.length === 0}
          title={trainingExamples.length === 0 ? "No data to export" : "Export data to JSON"}
        ...
        <button
          ...
          onClick={handleClear}
          disabled={trainingExamples.length === 0}
          title={trainingExamples.length === 0 ? "No data to clear" : "Clear all training data"}
