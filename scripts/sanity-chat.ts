...
const url = process.env.SANITY_URL || process.argv[2] || "http://localhost:3000/api/chat";
const prompt = process.env.SANITY_PROMPT || process.argv.slice(3).join(" ") || defaultPrompt;
